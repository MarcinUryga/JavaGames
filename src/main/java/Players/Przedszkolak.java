...
public class Przedszkolak extends Player{
	...
	public Przedszkolak(){
		...
		punkty = 0;
		pieniadze = 100;
        typGracza = "Przedszkolak";
        timeLimit = 360;
	}
	
	public Przedszkolak(String _name, int _punkty, int _pieniadze){
		name = _name;
		punkty = _punkty;
	...
	public void Komunikat_Wygranej(int punkty, int losuj_komunikat){
		...
		case 0: JOptionPane.showMessageDialog(null, "Brawo przedszkolaku " + name + " wygrales " + punkty+" pkt");break;
